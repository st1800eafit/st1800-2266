...
* carga de datos csv en spark desde un bucket S3 (desde EMR o por boto3)
...
en lab debe ser ejecutable en AWS EMR con los notebooks de EMR y datos en AWS S3. El desarrollo lo puede hacer local con Anaconda3 o python y la libreria pyspark instalada. Tambien lo puede hacer en google colab, o con aws boto3.
